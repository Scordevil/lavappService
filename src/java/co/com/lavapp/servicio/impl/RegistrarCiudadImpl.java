...
import co.com.lavapp.servicio.RegistrarCiudad;
...
public class RegistrarCiudadImpl implements RegistrarCiudad{
    ...
    @Override
    public Ciudad_TO registrarCiudad(
            @QueryParam("nombre") String nombre, 
            @QueryParam("idDepartamento") int idDepartamento) throws Exception {
        Ciudad_TO ciudad = new Ciudad_TO(nombre, new Departamento_TO(idDepartamento));
        CiudadDAO ciudadDAO = new CiudadDAOImpl();
        return ciudadDAO.registrarCiudad(ciudad);
    }    
}
