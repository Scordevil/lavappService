...
import co.com.lavapp.servicio.EliminarZona;
...
@Stateless
@Path("/eliminarZona")
public class EliminarZonaImpl implements EliminarZona{

    @GET
    @Produces({"application/json"})
    @Override
    public Zona_TO eliminarZona(@QueryParam("idZona") int idZona) throws Exception {
        Zona_TO zona = new Zona_TO(idZona);
        ZonaDAO zonaDao = new ZonaDAOImpl();
        return zonaDao.eliminarZona(zona);
    }    
}
