...
import co.com.lavapp.servicio.ConsultarRol;
...
public class ConsultarRolImpl implements ConsultarRol{
    ...
    @Override
    public Rol_TO consultarRol(@QueryParam("idRol") int idRol, @QueryParam("nombre") String nombre) throws Exception {
        Rol_TO rol = new Rol_TO(idRol, nombre);
        RolDAO rolDao = new RolDAOImpl();
        return rolDao.consultarRol(rol);
    }
